    ...
    [
        ...
        'content' => $this->render('_detail', [
            'model' => $model,
                ...
                [
        'label' => '<i class="glyphicon glyphicon-book"></i> '. Html::encode('Prihod'),
        'content' => $this->render('_dataPrihod', [
            'model' => $model,
            'row' => $model->prihods,
        ]),
    ],
            [
        'label' => '<i class="glyphicon glyphicon-book"></i> '. Html::encode('Rashod'),
        'content' => $this->render('_dataRashod', [
            'model' => $model,
            'row' => $model->rashods,
        ]),
    ],

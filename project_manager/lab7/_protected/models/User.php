...
//------------------------------------------------------------------------------------------------//
	...
	/**
	*Provjerava da li je admin. 
	*/
	public static function isAdmin($id){
		
		if(static::findOne(['id'=>$id])->getRoleName() == 'admin'){
			return true;
		}
		else
			return false;
	...
	/**
	*Provjerava da li je kreator. 
	*/
	public static function isCreator($id){
		
		if(static::findOne(['id'=>$id])->getRoleName() == 'theCreator'){
			return true;
		}
		else
			return false;
	...
	public static function isNadzor($id){
		
		if(static::findOne(['id'=>$id])->getRoleName() == 'nadzor'){
			return true;
		}
		else
			return false;
	...
	/**
	*Provjerava da li je radnik 
	*/
	public static function isRadnik($id){
		
		if(static::findOne(['id'=>$id])->getRoleName() == 'radnik'){
			return true;
		}
		else
			return false;
	...
	/**
	* provjera da li je sef projekta
	*/
	public static function isSef($id){
		
		if(static::findOne(['id'=>$id])->getRoleName() == 'sef projekta'){
			return true;
		}
		else 
			return false;
